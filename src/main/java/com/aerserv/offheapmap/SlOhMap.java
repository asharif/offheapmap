 ...
 * JVM heap size or GC issues.  It's a string->long map
 */
public class SlOhMap {
     ...
     */
    private native void put(long mPtr, String k, long v);

    /**
     * Gets the value associated with the key k
     */
    private native long get(long mPtr, String k);
     ...
     */
    private native long getValueAtItr(long mPtr, long itr);
     ...
     * Gets value at iterator. 
     */
    public long getValueAtItr(long itr) {
